  ...
  * ====================== */
  ...
  SelectMultiple.prototype = {
    ...
    'generateLisFromOption' : function(option, index, $container){
      ...
      var selectableLi = $('<li '+attributes+'><span><img src="'+$option.prop("label")+'" width="45" height="45" class="judgeimage" /><span style="margin-left:5px;">'+that.escapeHTML($option.text())+'</span></span><span class="pull-right ms-elem-selected" style="height:45px;line-height:45px;">✔</span></li>'),
