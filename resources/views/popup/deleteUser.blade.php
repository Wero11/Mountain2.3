...
<div class="modal modal-wide fade" id="deleteusermodal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					   ...
					   <div class="col-md-12">
							...
							<div class="row">
		                       <div class="col-xs-12 center">
		                            ...
		                            Are you sure you want to delete the selected user(s)?</label>
		                        </div>		                       
							</div>							
		                    <div class="row btn-holder text-center" style=" padding-top: 20px;">
		                        <div class="col-xs-12">
		                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="delete_judge" v-on="click:deleteJudge(formVariables.country_id)" >Ok</button>
