...
<div class="modal modal-wide fade" id="deletefeedmodal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content" style="width: 350px;margin-left:auto;margin-right:auto;">
					   ...
					   <div class="col-md-12">
							...
							<div class="row">
		                       <div class="col-xs-12 text-center">
                                  ...
                                  If you delete this, YOU CAN NOT RETRIVE THIS FEED in future.Are you sure want to continue?</label>
		                        </div>		                       
							</div>							
		                    <div class="row btn-holder text-center" style=" padding-top: 20px;">
		                        <div class="col-xs-12">
		                            <button type="button" class="btn btn-primary" id="hide_judge" data-dismiss="modal" v-on="click:blockUserFeed()" >Ok</button>
       ...
       <input type="hidden" name="deletefeedid" id="deletefeedid" value="" />
			</form>
		</div>
	</div>
</div>
