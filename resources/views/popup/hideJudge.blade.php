...
<div class="modal modal-wide fade" id="hidejudgemodal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-content" style="width: 350px;">
         <div class="modal-header">
          <a style="padding:3px 4px 3px 6px !important;float:right;cursor:pointer;" aria-hidden="true" data-dismiss="modal" onClick="getJudgeIcons('default')"><img src="{{ asset('public/images/close.png')}}" height="20px" width="20px"></a>
          	<h4 class="modal-title">Hide Judge(s)</h4>
         </div>
					   ...
					   <div class="col-md-12">
							...
							<div class="row">
		                       <div class="col-xs-12 center">
		                            ...
		                            Are you sure you want to hide the selected judge(s)?</label>
		                        </div>		                       
							</div>							
		                    <div class="row btn-holder text-center" style=" padding-top: 20px;">
		                        <div class="col-xs-12">
		                            <button type="button" class="btn btn-primary" id="hide_judge" v-on="click:hideJudge(formVariables.country_id)" >Ok</button>
