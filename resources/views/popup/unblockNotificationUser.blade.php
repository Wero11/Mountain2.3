...
<div class="modal modal-wide fade" id="userunblocknotificationmodal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content" style="width: 350px;">
					   ...
					   <div class="col-md-12">
							...
							<div class="row">
		                       <div class="col-xs-12 center">
		                            ...
		                            Are you sure you want to unblock this user?</label>
		                        </div>		                       
							</div>							
		                    <div class="row btn-holder text-center" style=" padding-top: 20px;">
		                        <div class="col-xs-12">
		                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="hide_judge" v-on="click:unblocknotifyuser()" >Ok</button>
       ...
       <input type="hidden" name="unblockuserid" id="unblockuserid" value="" />
			</form>
		</div>
	</div>
</div>
